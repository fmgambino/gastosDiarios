const CONFIG = {
  APPS_SCRIPT_URL: "https://script.google.com/macros/s/AKfycbxWgMT1XYBLuLrEqF7J2MzOFOryB7ADI15uvFBM5ZP9ERwg8uNIKGPtZo1LCttvoZgx/exec", // PEGÁ AQUÍ tu URL /exec del Web App
...
/**
 * API remota contra Google Apps Script sin fetch directo.
 *
 * Se usa JSONP por GET para evitar el bloqueo de CORS cuando la app se
 * publica en GitHub Pages y el backend corre como Web App de Apps Script.
 *
 * Requiere que el backend (Code.gs) soporte el parámetro "callback".
 */
